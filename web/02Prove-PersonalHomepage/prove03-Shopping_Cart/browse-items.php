...
<body>
    ...
    <div class="image_description">
        ...
        <div class="text">
            ...
            <button onclick="addToCart(value)" type="submit" name="item1" value="optic_mega_box">Add to Cart</button>
    ...
    <div class="image_description">
        ...
        <div class="text">
            ...
            <button onclick="addToCart(value)" type="submit" name="item2" value="contenders_hobby_box">Add to Cart</button>
